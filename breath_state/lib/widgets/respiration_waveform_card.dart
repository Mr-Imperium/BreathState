          ...
          Row(
            children: [
              Icon(Icons.air_rounded,
                  color: AppTheme.softTeal.withOpacity(0.8), size: 20),
              ...
              if (_currentBpm > 0)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: AppTheme.softTeal.withOpacity(0.15),
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: Text(
                    '${_currentBpm.toStringAsFixed(1)} bpm',
            ...
            child: _buffer.length < 2
                ...
                : CustomPaint(
                    painter: _WaveformPainter(
                      ...
                      lineColor: AppTheme.softTeal,
                      peakColor: AppTheme.roseAccent,
                      bgLineColor: Theme.of(context)
                          .colorScheme
                          .onSurface
                          .withOpacity(0.06),
                    ),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final idx in peakIndices) {
      if (idx >= 0 && idx < data.length) {
        canvas.drawCircle(
          Offset(idx * xStep, mapY(data[idx])),
          4,
          peakPaint,
        );
      }
